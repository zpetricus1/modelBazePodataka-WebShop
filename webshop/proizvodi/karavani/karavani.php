  ...
  <div class="body">
    ...
    <div class="bodyContentLimuzine">
        ...
        <?php
          ...
          $sql = "SELECT proizvod_id from proizvodi join model as mo on id_model=mo.model_id join kategorija as k on mo.id_kategorija=k.kategorija_id where k.kategorija_id = 2";
