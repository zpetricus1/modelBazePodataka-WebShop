  ...
  <div class="body">
    ...
    <div class="bodyContent">
      ...
      <form class="" action="#" method="post">
        ...
        <input name="naslov" id="naslov" type="text" placeholder="Naslov"><br><br>
        <textarea rows="10" cols="26" name="upit" id="upit" placeholder="Upit"></textarea><br>
        <input type="submit" id="submit" name ="submit" class="buttonEmail" value="Pošalji upit"><br>
      </form>
      <?php
      if(isset($_POST['submit'])){
        ...
        $unos=pg_query($con,"insert into upit (naslov,upit,id_korisnik) values ('".$naslov."','".$upit."','".$_COOKIE['korisnik_id']."')");
