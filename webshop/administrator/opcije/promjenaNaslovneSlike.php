<?php
  ...
  require_once '../../skripteBP/prijenos.php';
 ?>
<!DOCTYPE html>
<!--JAVASCRIPT-->
<div id="fb-root"></div>
...
<html lang="eng" dir="ltr">
  ...
  <div class="body">
    ...
    <div class="bodyContent">
      ...
      <h2>Prenesi željenu sliku</h2><br>
      <form class="" action="../../skripteBP/prijenos.php" method="post" enctype="multipart/form-data">
        <input type="file" name="promjenaNaslovneSlike" id="promjenaNaslovneSlike"><br><br><br>
        <input type="submit" name="submit" id="submit" class="buttonEmail" value="Promjeni">
      </form>
