<?php
  ...
  require_once '../../skripteBP/kreirajNovuAkciju.php';
 ?>
<!DOCTYPE html>
<!--JAVASCRIPT-->
<div id="fb-root"></div>
  ...
  <div class="body">
    ...
    <div class="bodyContent">
      ...
      <form class="" action="?" method="post">
        <label for="iznos">Iznos u postotcima : </label>
        <input type="number" id="iznos" name="iznos" min="0" max="100" step="10" value="10"><br><br>
        <label for="pocetak">Početak akcije : </label>
        <input type="date" id="pocetak" name="pocetak"><br><br>
        <label for="kraj">Kraj akcije : </label>
        <input type="date" id="kraj" name="kraj"><br><br>
        <input type="submit"name="submit" id="submit" class="buttonPrijava" value="Kreiraj"><br><br>
      </form>
